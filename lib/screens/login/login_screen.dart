...
import '../lock/forgot_pin_screen.dart';
...
class _LoginScreenState extends State<LoginScreen> {
  ...
  Future<void> _onForgotPin() async {
    ...
    // If ForgotPinScreen ended in a full data erase, it already
    // navigated to RegisterScreen itself (replacing this screen in the
    // stack). If it ended in a successful OTP-based reset, it already
    // navigated to HomeScreen. Either way there's nothing left to do
    // here when control returns (e.g. user just pressed back).
  }
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              TextButton(
                onPressed: _checkingBiometric ? null : _onForgotPin,
